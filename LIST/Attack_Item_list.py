...
def Attack(driver):
    ...
    # 2apge
    # 성스러운 폭탄
    Holy = soup1.select_one('#tbodyItemList > tr:nth-child(1) > td:nth-child(4) > div > em')
    Holy = int(Holy.text)

    # 파괴 폭탄
    Destruction = soup1.select_one('#tbodyItemList > tr:nth-child(2) > td:nth-child(4) > div > em')
    Destruction = int(Destruction.text)

    # 빛나는 섬광 수류탄
    S_Flash = soup1.select_one('#tbodyItemList > tr:nth-child(3) > td:nth-child(4) > div > em')
    S_Flash = int(S_Flash.text)

    # 빛나는 화염 수류탄
    S_Flame = soup1.select_one('#tbodyItemList > tr:nth-child(4) > td:nth-child(4) > div > em')
    S_Flame = int(S_Flame.text)

    # 빛나는 냉기 수류탄
    S_Cold_Air = soup1.select_one('#tbodyItemList > tr:nth-child(5) > td:nth-child(4) > div > em')
    S_Cold_Air = int(S_Cold_Air.text)

    # 빛나는 전기 수류탄
    S_Electric = soup1.select_one('#tbodyItemList > tr:nth-child(6) > td:nth-child(4) > div > em')
    S_Electric = int(S_Electric.text)

    # 빛나는 점토 수류탄
    S_Clay = soup1.select_one('#tbodyItemList > tr:nth-child(7) > td:nth-child(4) > div > em')
    S_Clay = int(S_Clay.text)

    # 빛나는 회오리 수류탄
    S_Tornado = soup1.select_one('#tbodyItemList > tr:nth-child(8) > td:nth-child(4) > div > em')
    S_Tornado = int(S_Tornado.text)

    # 빛나는 암흑 수류탄
    S_Dark = soup1.select_one('#tbodyItemList > tr:nth-child(9) > td:nth-child(4) > div > em')
    S_Dark = int(S_Dark.text)

    # 빛나는 수면 폭탄
    S_sleeping = soup1.select_one('#tbodyItemList > tr:nth-child(10) > td:nth-child(4) > div > em')
    ...
    # 2page
    # 빛나는 파괴 폭탄
    S_Destruction = soup2.select_one('#tbodyItemList > tr:nth-child(1) > td:nth-child(4) > div > em')
    S_Destruction = int(S_Destruction.text)

    # 빛나는 부식 폭탄
    S_Corrosion = soup2.select_one('#tbodyItemList > tr:nth-child(2) > td:nth-child(4) > div > em')
    S_Corrosion = int(S_Corrosion.text)

    # 빛나는 성스러운 폭탄
    S_Holy = soup2.select_one('#tbodyItemList > tr:nth-child(3) > td:nth-child(4) > div > em')
    S_Holy = int(S_Holy.text)

    #빛나는 천둥 물약 4

    # 섬광수류탄
    Flash = soup2.select_one('#tbodyItemList > tr:nth-child(5) > td:nth-child(4) > div > em')
    Flash = int(Flash.text)

    # 화염 수류탄
    Flame = soup2.select_one('#tbodyItemList > tr:nth-child(6) > td:nth-child(4) > div > em')
    Flame = int(Flame.text)

    # 냉기 수류탄
    Cold_Air = soup2.select_one('#tbodyItemList > tr:nth-child(7) > td:nth-child(4) > div > em')
    Cold_Air = int(Cold_Air.text)

    # 전기수류탄
    Electric = soup2.select_one('#tbodyItemList > tr:nth-child(8) > td:nth-child(4) > div > em')
    Electric = int(Electric.text)

    # 암흑 수류탄
    Dark = soup2.select_one('#tbodyItemList > tr:nth-child(9) > td:nth-child(4) > div > em')
    Dark = int(Dark.text)

    # 부식 폭탄
    Corrosion = soup2.select_one('#tbodyItemList > tr:nth-child(10) > td:nth-child(4) > div > em')
    ...
    # 3page
    # 천둥 물약
    Thunder = soup3.select_one('#tbodyItemList > tr:nth-child(1) > td:nth-child(4) > div > em')
    Thunder = int(Thunder.text)

    # 회오리 수류탄
    Tornado = soup3.select_one('#tbodyItemList > tr:nth-child(2) > td:nth-child(4) > div > em')
    Tornado = int(Tornado.text)

    # 점토 수류탄
    Clay = soup3.select_one('#tbodyItemList > tr:nth-child(3) > td:nth-child(4) > div > em')
    Clay = int(Clay.text)
